    ...
    <div class="statblocks mt-6">
      <ClientOnly>
        ...
        <div class="statblocks-description">
          ...
          The new version retains the dynamic CR concept but does all the math
          for you behind the scenes: input the value you feel is appropriate for
          the base CR of the monster, and let the editor do the rest.
          ...
          <ul class="static">
            ...
            <li class="item-spells">
              ...
              now also support spell slots, one of the most requested features
              by users.
            </li>
            <li class="item-muscle">
              ...
              backgrounds, but also <em>items, traps and lair actions</em>, to
              better help DMs in the creation of adventures and campaigns.
            </li>
          </ul>
        </div>
      </ClientOnly>
