  ...
  <div class="background pb-8">
    ...
    <div class="max-w-[50rem] mx-auto w-100">
      ...
      <p class="content">
        ...
        associates (collectively, “<b>we</b>“, “<b>us</b>“, “<b>our</b>“). We
      ...
      <p class="content">
        ...
        or authentication data; information you provide when using our products
        (e.g., business name, business email, business address, business fax,
        company website, etc.); information in blog comments; financial
        information (e.g., last four digits of your debit or credit card number,
        billing history, billing address, card type, issuing bank, expiration
        date, card origin by country); profile photo; and other similar
        information. Payment Data. We may collect data necessary to process your
        ...
        your payment instrument. All payment data is stored by Stripe. You may
        find their privacy notice link here
        https://stripe.com/en-gb-it/privacy.<br />
      ...
      <p class="content">
        ...
        the performance of the contract. To manage user accounts. We may use
        your information for the purposes of managing our account and keeping it
        in working order. To request feedback. We may use your information to
        request feedback and to contact you about your use of our Services. To
        ...
        support@monstershuffler.com and be sure to include your name,
        testimonial location, and contact information. To protect our Services.
        We may use your information as part of our efforts to keep our Services
        ...
        to determine how to respond. To fulfill and manage your orders. We may
        use your information to fulfill and manage your orders, payments,
        upgrades, or refunds made through the Website or otherwise through our
        Services. To deliver and facilitate delivery of services to the user. We
        may use your information to provide you with the requested service. To
        ...
        you might have with the use of our Services. To administer prize draws
        and competitions. We may use your information to administer prize draws
        and competitions when you elect to participate in our competitions. To
        ...
        evaluate and improve our Website, Services, products, marketing and your
      ...
      <p class="content">
        ...
        third parties to use tracking technology on the Website, which will
        enable them to collect data on our behalf about how you interact with
      ...
      <p class="content">
        ...
        you close and reopen your browser, you user is automatically logged in
        again.
      </p>
      ...
      <p class="content">
        ...
        (see “WILL YOUR INFORMATION BE SHARED WITH ANYONE?” above), in the
